    ...
    switch (name) {
      ...
      case "password":
        if (!value) {
          ...
          newErrors.passErr = null;
        }
        if (userData.confirmPassword && value !== userData.confirmPassword) {
          newErrors.confirmPassErr = "Password doesn't match*";
        } else {
      ...
      case "confirmPassword":
        if (!value) {
          newErrors.confirmPassErr = "Confirm password is required*";
          ...
          <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
            ...
            <div>
              <div className="flex flex-row mx-3">
                ...
                <div className="w-full px-3 mb-5 flex-row">
                  <label htmlFor="username text-xs font-semibold px-1">
                    User Name
                  </label>
                  <div className="flex flex-row">
                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
              ...
              <div className="flex ">
                <div className="w-full px-2 mb-12">
                  ...
                  <p className="text-red-600 text-md">{errors?.firstNameErr}</p>
                </div>
                <div className="w-full px-3 mb-12">
                  <label htmlFor="" className="text-xs font-semibold px-1">
                    Last Name
              ...
              <div className="px-5">
                ...
                >
                  {preview ? (
                    <img
                      src={preview}
                      className="w-[120px] h-[120px] rounded-[60px] object-cover"
                    />
                  ) : (
                    <FaRegUser size={30} />
                  )}
