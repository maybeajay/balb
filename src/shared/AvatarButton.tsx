  ...
  return (
    <div className="absolute">
      <div className="relative" onClick={handleMenuOpen}>
        ...
        >
          <img className="w-10 h-10 rounded-full" src={src} alt="User Avatar" />
        </button>
        {/* Dropdown Menu */}
        {isMenuVisible && (
          <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg gap-3">
            <Link
              to={"/profile/me"}
              className="flex flex-row items-center hover:text-[#8b5cf6] m-4 gap-3"
            >
              <User />
              Profile
            </Link>
            ...
            <div
              className="flex flex-row hover:text-[#8b5cf6] m-4 hover:cursor-pointer gap-3"
